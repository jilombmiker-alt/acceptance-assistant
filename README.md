...
[观看或下载 3 分 30 秒演示视频](media/demo.mp4) · [旁白与分镜](docs/video-script.md) · [修复对比记录](evaluation/report-repair-case.json)
...
当前不自动修改源代码、不自动采集其他聊天、不自动安装 Codex 全局记忆；任意业务、主观质量和任意 PDF 内容仍需专门验收。公开仓库不是已经部署的公网产品。
